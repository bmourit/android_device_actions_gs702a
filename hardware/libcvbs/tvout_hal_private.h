...
/*功能：设置/获取CVBS制式。参数类型:struct tv_settings*/
...
enum TV_MODE_TYPE {
	...
	TV_MODE_PAL = 0, TV_MODE_NTSC = 1, TV_MODE_MAX = 2
};

enum TV_MODE {
	TVOUT_CVBS = 1, TVOUT_YPBPR, TVOUT_MAX
};

enum TV_ENCODER_TYPE {
	TV_ENCODER_INTERNAL, TV_ENCODER_EXTERNAL, TV_ENCODER_MAX
};

enum TVOUT_DEV_STATUS {
	TVOUT_DEV_PLUGOUT = 1, TVOUT_DEV_PLUGIN, TVOUT_DEV_MAX
};
