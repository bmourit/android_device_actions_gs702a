...
protected:
    ...
    virtual status_t fillThisBuffer(void* frameBuf, CameraFrame::FrameType frameType, CameraFrame::StreamType streamType);
    ...
    virtual void onReturnFrame(void * frameBuf, CameraFrame::FrameType frameType, CameraFrame::StreamType streamType);
...
private:
    ...
    static status_t insertSceneModes(CameraProperties::Properties*, OMX_ACT_CAPTYPE &);
    ...
    static status_t findBestSize(OMX_ACT_VARRESTYPE hwSizes[], OMX_U16 hwSizeNum, int width, int height, int *bestWidth, int *bestHeight);
    ...
    void omxColorToFrameColor(OMX_COLOR_FORMATTYPE omxcolor, OMX_VIDEO_CODINGTYPE codingtype, CameraFrame::FrameFormat &framecolor);
