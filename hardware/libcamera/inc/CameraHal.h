...
#define MAX_SW_ENC_WIDTH   800 
#define MAX_SW_ENC_HEIGHT  600 
...
#define CAMHAL_GRALLOC_USAGE GRALLOC_USAGE_HW_CAMERA
...
public:
    ...
    enum FrameType
    {
        ...
        VIDEO_FRAME_SYNC = (1<<1), ///Timestamp will be updated for these frames
        FD_FRAME_SYNC = (1<<2),
        RAW_FRAME_SYNC = (1<<3),
        IMAGE_FRAME_SYNC = (1<<4), ///Image Frame is the image capture output frame
        MAX_FRAME_TYPE = 5, 
...
public:
    ...
    void vceResize(CameraFrame* frame, unsigned char *src, unsigned char *dest, int resizeType);
#endif
...
private:
    ...
    ActUtils::MessageQueue mFrameQ;
    ActUtils::MessageQueue mResizeQ;
    ActUtils::MessageQueue mJpegQ;
    ...
    OMXVceJpegEncoder *mVceJpegEncoder;
#endif
