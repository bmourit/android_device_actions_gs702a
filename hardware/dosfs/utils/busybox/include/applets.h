...
USE_CHECKSUM_AND_RECOVORY(APPLET(ck2recovery, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
...
USE_FLUSH_FLASH(APPLET(flush_flash, _BB_DIR_USR_SBIN, _BB_SUID_NEVER))
...
USE_UDISK_UPGRADE(APPLET(udisk_upgrade, _BB_DIR_USR_BIN, _BB_SUID_NEVER))
