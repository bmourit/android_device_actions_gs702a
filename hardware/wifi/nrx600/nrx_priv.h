...
/* $Id: nrx_priv.h 21344 2011-12-22 08:56:13Z phth $ */
...
/*!
  * @internal
  * @ingroup MISC
  * @brief <b>Perform a low-level ioctl with variable size (we use this for buffer transactions)</b>
  *
  ...
  */
int
nrx_nrxioctl_raw (nrx_context ctx,
                  unsigned int cmd,
...
int
nrx_p2p_set_generic_elem (nrx_context ctx,
                          buf_t p2p_params);

int
nrx_p2p_set_freq (nrx_context ctx,
                  wpas_freq_params_t p2p_params);

int
nrx_p2p_set_params (nrx_context ctx,
                    wpas_p2p_params_t p2p_params);

int
nrx_p2p_set_ap_wps_ie (nrx_context ctx,
                       buf_t buf_beacon,
                       buf_t buf_proberesp,
                       buf_t buf_assocresp,
...
int
nrx_p2p_start_neg (nrx_context ctx,
...
int
nrx_p2p_prov_end (nrx_context ctx,
                  int result,
                  m80211_mac_addr_t peer_addr);

int
nrx_p2p_listen (nrx_context ctx,
                uint32_t timeout,
                uint8_t listen_channel ,
                uint8_t listen_reg_class);

int
nrx_p2p_set_noa (nrx_context ctx,
                 uint8_t count,
                 uint32_t start,
                 uint32_t duration);

int
nrx_p2p_set_powersave (nrx_context ctx,
                       int legacy_ps,
                       int opp_ps,
                       int ctwindow);

int
nrx_p2p_set_intra_bss (nrx_context ctx,
                       int enabled);

int
nrx_p2p_prov_disc_req (nrx_context ctx,
                       m80211_mac_addr_t peer_addr,
                       uint16_t config_methods);

int
nrx_p2p_sd_request (nrx_context ctx,
                    m80211_mac_addr_t dst,
                    buf_t tlvs);

int
nrx_p2p_sd_cancel_request (nrx_context ctx,
                           uint64_t req);

int
nrx_p2p_sd_response (nrx_context ctx,
                     int freq,
                     m80211_mac_addr_t dst,
...
int
nrx_p2p_service_update (nrx_context ctx);

int
nrx_p2p_reject (nrx_context ctx,
                m80211_mac_addr_t addr);

int
nrx_p2p_invite (nrx_context ctx,
...
int
nrx_get_wpa_ie_buffer (nrx_context ctx,
                       char* buf ,
                       int max_len);

int
nrx_send_eapol (nrx_context ctx,
                m80211_mac_addr_t dst ,
                uint16_t proto,
                char *pkt,
                uint32_t pkt_len);
...
int
nrx_softap_set_encryption (nrx_context ctx,
                           nrx_encryption_t cipher,
                           m80211_mac_addr_t addr,
                           int idx,
                           char *key,
                           int key_len,
